...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-tl-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-tl-accent/10 blur-[120px] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <p className="mt-2 text-center text-sm text-tl-muted">
          Or <Link to="/register" className="font-medium text-tl-accent hover:text-cyan-400">create a new account</Link>
        </p>
      </div>
